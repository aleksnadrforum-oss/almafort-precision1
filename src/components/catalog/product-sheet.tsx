                ...
                <div className="mt-6 space-y-2">
                  ...
                  {(
                    [
                      ...
                      ...(["OP-H20", "OP-H35", "OP-H50"].includes(product.sku)
                    ...
                    <a
                      key={fmt}
                      href={href}
                      download={`${product.sku === "OP-H20" ? "Opora-mebelnaya-h20" : product.sku === "OP-H35" ? "Opora-mebelnaya-h35" : product.sku === "OP-H50" ? "Opora-mebelnaya-h50" : product.sku}.${fmt}`}

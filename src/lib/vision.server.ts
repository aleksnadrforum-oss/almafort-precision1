...
"Статус FOREIGN ставится ТОЛЬКО если в кадре зафиксированы лица/люди, текст документов или " +
  ...
  "Режим подборки аналогов: если точного артикула нет, НЕ блокируй пользователя — верни " +
  "found=false, status NOT_FOUND, confidence 60 и максимально подробное detected_features, " +
  "чтобы система показала 2–3 ближайшие по форме позиции каталога.";
